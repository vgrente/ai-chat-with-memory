package io.vgrente.ai_chat_with_memory.docs

import io.vgrente.ai_chat_with_memory.AiChatWithMemoryApplication
...
private fun alias(module: ApplicationModule): String =
    module.identifier.toString().replace(".", "_")

private fun topLevelId(module: ApplicationModule): String =
    module.identifier.toString().substringBefore(".")
...
fun main() {
    ...
    val mermaid = buildString {
        ...
        for (parent in topLevel) {
            ...
            nested.forEach { child ->
                child.getDirectDependencies(modules).uniqueModules()
